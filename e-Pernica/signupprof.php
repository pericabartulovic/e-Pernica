        ...
        <section class="section-default">
            ...
            if (isset($_GET["error"])) {
                if ($_GET["error"] == "emptyfields") {
                    ...
                    echo '<p style="margin-left: 5px; color: crimson">Korisnik već postoji! Dodajte broj ili slovo po želji.</p>';
                }
              } 
            ...
            ?>
            <form id="sakrij" action="includes/signupprof.inc.php" method="post">
                <div class="form-group">
                    <input type="text" name="imeprez" placeholder="Ime i prezime">
                </div>
                <div class="form-group">
